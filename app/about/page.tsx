...
const values = [
  {
    ...
    description:
      "We design every workflow to support the people who keep fleets safe, compliant, and dependable.",
  },
  {
    title: "Momentum in partnership",
    description:
      "Customer teams contribute to our roadmap directly, shaping releases around real operations challenges.",
  },
  {
    title: "Sustainably scalable",
    description:
      "From energy use to vendor selection, we optimize for the long term health of communities and the planet.",
  },
];
...
const milestones = [
  {
    year: "2016",
    headline: "Ozis Auto founded",
    detail: "Former fleet managers, engineers, and designers join forces in San Francisco to modernize dispatch technology.",
  },
  {
    year: "2019",
    headline: "Global coverage",
    detail: "Regional hubs open in London and Sydney, launching 24/7 support for customers across three continents.",
  },
  {
    year: "2022",
    headline: "Intelligence suite",
    detail: "Predictive maintenance and connected mobility modules debut, integrating with 40+ telematics partners.",
  },
  {
    year: "2024",
    headline: "Sustainability impact",
    detail: "Customer fleets log 18% reduction in fuel use through route optimization and electrification initiatives.",
  },
];
