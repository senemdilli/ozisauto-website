  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <section className="mx-auto max-w-6xl px-6 pb-20 pt-24">
        <div className="grid gap-12 rounded-[32px] bg-white p-10 shadow-[0_32px_80px_rgba(15,23,42,0.08)] lg:grid-cols-[1.05fr_0.95fr] lg:p-16">
          ...
          <div className="relative overflow-hidden rounded-[28px]">
            ...
            <div className="relative flex h-full flex-col justify-end gap-6 p-10 text-white">
              <div>
